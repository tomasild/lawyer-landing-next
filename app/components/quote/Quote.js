...
const Quote = () => {
  return (
    <div
      id="quote"
      className="bg-palace bg-cover bg-center py-20 relative md:bg-fixed"
    >
      {/* Mask overlay */}
      ...
      <div className="max-w-4xl mx-4 md:mx-auto text-center relative z-10">
        ...
        <h2 className="text-[2rem] md:text-[4rem] font-boldfont-bold text-otis-100 mb-6 drop-shadow-lg text-pretty">
